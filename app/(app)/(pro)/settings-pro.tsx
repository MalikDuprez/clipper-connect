  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Paramètres pro</Text>
      </View>

      <View style={styles.placeholder}>
        <Ionicons name="settings-outline" size={60} color="#DDD" />
        <Text style={styles.placeholderText}>Paramètres pro en cours de développement</Text>
      </View>
    </View>
  );
}
